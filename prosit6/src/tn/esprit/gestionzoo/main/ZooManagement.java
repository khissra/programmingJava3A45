...
public class ZooManagement {
    ...
    public static void main(String[] args) {
        ...
        //////  Instruction 21 /////////
        //Aquatic aquatic = new Aquatic("Fish", "Fish1", 1, true, "Sea");
        Terrestrial terrestrial = new Terrestrial("Fox", "F1", 1, true, 4);
        //////  Instruction 23 /////////
        //System.out.println(aquatic);
        //System.out.println(terrestrial);

        Dolphin dolphin = new Dolphin("Delphin", "Delphin1", 1, true, "Ocean", 10);
        Penguin penguin = new Penguin("Penguin", "Penguin1", 1, true, "Ocean", 20);
        ...
        //////  Instruction 27 /////////
        for (Aquatic Animalaquatic : myZoo1.getAquaticAnimals()) {
              Animalaquatic.swim();  
        }
